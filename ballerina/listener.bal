...
public isolated class Listener {
    ...
    @java:Method {
        'class: "io.ballerina.stdlib.nats.basic.consumer.Register"
    } external;
    ...
    @java:Method {
        'class: "io.ballerina.stdlib.nats.basic.consumer.Detach"
    } external;
...
@java:Method {
    'class: "io.ballerina.stdlib.nats.basic.consumer.Start"
} external;
